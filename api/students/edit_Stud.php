...
try {
    ...
    $updateStdSql = "UPDATE students SET regNo='$regNo', firstname='$firstname', lastname='$lastname', email='$email', gender='$gender', department_id='$dept_id' WHERE id='$id'";
    $query = $conn->query($updateStdSql);
